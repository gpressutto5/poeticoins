defmodule Poeticoins.Exchanges.Client do
  ...
  def connect(client) do
    ...
    {:ok, conn} = :gun.open(server_host(client.module), server_port(client.module), connOpts)
  ...
  defp subscription_frames(module, currency_pairs), do: module.subscription_frames(currency_pairs)
  defp handle_ws_message(msg, client), do: client.module.handle_ws_message(msg, client)
